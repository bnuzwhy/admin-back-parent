...
import com.why.framework.utils.RequestUtils;
...
public class AdminHandlerExceptionResolver extends AbstractHandlerExceptionResolver {
     ...
     */
    public AdminHandlerExceptionResolver() {
    ...
    protected ModelAndView doResolveException(HttpServletRequest request, HttpServletResponse response, Object handler,
        ...
        try {
            if (ex instanceof AdminException) {
                handleApi((AdminException) ex, request, response);
    ...
    private void handleAuthenticationException(AuthenticationException ex, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (throwable instanceof AdminException) {
            AdminException cause = (AdminException) throwable;
            ResponseUtils.sendFail(request, response, cause.getErrorStatus(), ex);
        } else {
            ResponseUtils.sendFail(request, response, AdminResultCode.FORBIDDEN, ex);
        }
    }
     ...
     */
    protected void handleApi(AdminException ex,
                             HttpServletRequest request, HttpServletResponse response) {
        ResponseUtils.sendFail(request, response, ex.getErrorStatus());
    ...
    protected void handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex,
                                                       HttpServletRequest request, HttpServletResponse response) {
        ResponseUtils.sendFail(request, response, AdminResultCode.METHOD_NOT_ALLOWED, ex);
    }
    ...
    protected void handleShiroException(ShiroException ex,
                                        HttpServletRequest request, HttpServletResponse response) {
        ResponseUtils.sendFail(request, response, AdminResultCode.UNAUTHORIZED, ex);
    }
    ...
    protected void handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex, HttpServletRequest request,
        ...
        ResponseUtils.sendFail(request, response, AdminResultCode.UNSUPPORTED_MEDIA_TYPE, ex);
    }
    ...
    protected void handleHttpMediaTypeNotAcceptable(HttpMediaTypeNotAcceptableException ex, HttpServletRequest request,
                                                    HttpServletResponse response) {
        ResponseUtils.sendFail(request, response, AdminResultCode.NOT_ACCEPTABLE, ex);
    }
    ...
    protected void handleMissingPathVariable(MissingPathVariableException ex, HttpServletRequest request,
                                             HttpServletResponse response) {
        ResponseUtils.sendFail(request, response, AdminResultCode.INTERNAL_SERVER_ERROR, ex);
    }
    ...
    protected void handleMissingServletRequestParameter(MissingServletRequestParameterException ex,
                                                        HttpServletRequest request, HttpServletResponse response) {
        ResponseUtils.sendFail(request, response, AdminResultCode.BAD_REQUEST, ex);
    }
    ...
    protected void handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpServletRequest request,
        ...
        if (ex.getCause() instanceof JsonParseException) {
            ResponseUtils.sendFail(request, response, AdminResultCode.JSON_FORMAT_ERROR, ex);
        } else {
            ResponseUtils.sendFail(request, response, AdminResultCode.BAD_REQUEST, ex);
        }
    }
    ...
    protected void handleNoHandlerFoundException(NoHandlerFoundException ex, HttpServletRequest request,
                                                 HttpServletResponse response) {
        ResponseUtils.sendFail(request, response, AdminResultCode.NOT_FOUND, ex);
    }
    ...
    protected void handleAsyncRequestTimeoutException(AsyncRequestTimeoutException ex, HttpServletRequest request,
                                                      HttpServletResponse response) {
        ResponseUtils.sendFail(request, response, AdminResultCode.SERVICE_UNAVAILABLE, ex);
    }
