...
/**
 * @description: Lambda删除wrapper
 * @author: Stan | stan.wang@paytm.com
 * @create: 2021/1/25 8:57 下午
 * @SafeVarargs | @link: https://www.cnblogs.com/springmorning/p/10285780.html
 **/
public class LambdaDeleteWrapperChain<T>
        extends AbstractChainWrapper<T, SFunction<T, ?>, LambdaDeleteWrapperChain<T>, LambdaQueryWrapper<T>>
